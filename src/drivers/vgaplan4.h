...
#define readl(reg) ((*(volatile unsigned long * const)(reg)))
#define outb(val, reg) ((*(volatile unsigned long * const)(reg)) = (val))
#define outw(val, reg) ((*(volatile unsigned long * const)(reg)) = (val))
