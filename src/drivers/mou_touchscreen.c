...
/* The following devices are supported by this driver:
   TOUCHSCREEN_SC1000 - Lange SC1000 Display
...
#ifdef TOUCHSCREEN_SC1000
#include "touchscreen_SC1000.h"
#endif
...
#if defined(TOUCHSCREEN_IPAQ) || defined(TOUCHSCREEN_ADS7846) || defined(TOUCHSCREEN_SC1000)
