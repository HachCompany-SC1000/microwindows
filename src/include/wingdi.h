...
int WINAPI	DrawTextA(HDC hdc, LPCSTR lpString, int nCount, LPRECT lpRect,
			UINT uFormat);
int WINAPI	DrawTextU8(HDC hdc, LPCSTR lpString, int nCount, LPRECT lpRect,
			UINT uFormat);
int WINAPI	DrawTextW(HDC hdc, LPCWSTR lpString, int nCount, LPRECT lpRect,
			UINT uFormat);
//#define DrawText DrawTextA
#define DrawText DrawTextU8

BOOL WINAPI	DrawDIB(HDC hdc,int x, int y,PMWIMAGEHDR pimage); /* microwin*/
BOOL WINAPI     DrawFileImage(HDC hdc, int x, int y, int h, int w, char *file);  /* microwin*/
